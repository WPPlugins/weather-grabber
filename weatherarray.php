...
$weatherArray['wxgrabber_fire_file'] = $options['wxgrabber_fire_file']; //Fire Information Text File
$weatherArray['wxgrabber_solarURL'] = $options['wxgrabber_solarURL']; //Solar URL for link from Solar Radiation value
...
if ($weatherArray['sensors'] == 0){ //Checking for Standard (0) vs. Extended (1) sensors/mode...
	...
	$weatherArray['hiWindGustSpeedTime'] = $weatherArray['hiWindSpeedTime'];
	$weatherArray['dayhighwindgustdir'] = $weatherArray['dayhighwinddir'];
	$weatherArray['dayhighwindgustdirdeg'] = '&nbsp;';
	$weatherArray['hiWindGustSpeed'] = $weatherArray['hiWindSpeed'];
	}
}// END SENSORS 0 IF

else {  //SENSORS ARE EXTENDED (1)
...
/**************************** END OF DATABASE QUERY SECTION *******************/ 
		...
		// First do the Units 
			...
			$weatherArray = calculateHumidex($weatherArray);
