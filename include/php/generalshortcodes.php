...
$output = $output . '<td colspan="1" class="tg-center" style="' . $weatherArray['outsideHeatIndexCSS'] . '" title="Heat Index"><strong>Heat Index</strong><br/>' . $weatherArray['outsideHeatIndex'] . $weatherArray['tempUnit'] . '</td>';
}
else {
$output = $output . '<td colspan="1" class="tg-center" style="' . $weatherArray['outsideHumidexCSS'] . '" title="Humidex"><strong>Humidex</strong><br/>' . $weatherArray['outsideHumidex'] . $weatherArray['tempUnit'] . '</td>';
}
...
$output = $output . '<td colspan="1" class="tg-center" style="' . $weatherArray['solarPotentialCSS'] . '"><span title="Solar Power" ><a href="'. $weatherArray['wxgrabber_solarURL'] .' ">Solar Potential</a><br /><a href="'. $weatherArray['wxgrabber_solarURL'] .' ">' . $weatherArray['solarPotential'] . ' ' . $weatherArray['solarUnit'] . '</a></span></td>';

$output = $output . '<td colspan="1" class="tg-center" style="' . $weatherArray['solarRadCSS'] . '"><span title="Solar Radiation" ><a href="'. $weatherArray['wxgrabber_solarURL'] .' ">Solar Radiation</a><br /><a href="'. $weatherArray['wxgrabber_solarURL'] .' ">' . $weatherArray['solarRad'] . ' ' . $weatherArray['solarUnit'] . '</a></span></td></tr>';
...
parent::_construct(false, $name = 'WXGB - ShortCodes');
// Load jQuery
