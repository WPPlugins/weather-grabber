...
function calculateHumidex($weatherArray) {

//https://en.wikipedia.org/wiki/Humidex

	$tempexponent = exp(5417.7530 * (1/273.16 - 1 / ($weatherArray['outsideDewPt']+273.15)));
	$powertemp = (6.11 * $tempexponent) - 10;

	$weatherArray['outsideHumidex'] = $weatherArray['outsideTemp']+ (0.5555 * $powertemp);
	$weatherArray['outsideHumidex'] = round($weatherArray['outsideHumidex'], 2);
