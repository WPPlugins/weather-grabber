...
public function __construct() {
		...
		$widget_ops = array( 
			'class_name' => 'wxGrabber_main_values_widget',
			'description' => 'Custom Weather Values Widget',
			);
		parent::__construct('wxGrabber_main_values_widget', 'WXGB - Custom Weather Values', $widget_ops );
